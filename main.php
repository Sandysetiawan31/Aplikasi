...
<html>
  <head>
    <meta charset="UTF-8">
    <title>Aplikasi Rekam Medis PAsien</title>
    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="?module=beranda" class="logo">
          ...
          <span style="font-size:15px">Rekam Medis Pasien</span>
        </a>
      ...
      <footer class="main-footer">
        <center><strong>Copyright &copy; 2019 - Desainer: Sandy Setiawan</strong></center>
      </footer>
    </div><!-- ./wrapper -->
