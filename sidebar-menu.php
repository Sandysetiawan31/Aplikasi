...
if ($_SESSION['hak_akses']=='Super Admin') { ?>
 ...
 // jika menu data pasien dipilih, menu data pasien aktif
  if ($_GET["module"]=="Pasien" || $_GET["module"]=="form_obat") { ?>
    <li class="active">
      <a href="?module=pasien"><i class="fa fa-folder"></i> Data Pasien </a>
      </li>
  <?php
  }
 ...
 // jika menu data kunjungan dipilih, menu data kunjungan aktif
  if ($_GET["module"]=="Kunjungan" || $_GET["module"]=="form_obat") { ?>
    <li class="active">
      <a href="?module=kunjungan"><i class="fa fa-folder"></i> Data Kunjungan </a>
      </li>
  <?php
  }
  // jika tidak, menu data kunjungan tidak aktif
  else { ?>
    <li>
      <a href="?module=kunjungan"><i class="fa fa-folder"></i> Data Kunjungan </a>
      </li>
 ...
 // jika menu data rekam medis dipilih, menu data medis  aktif
  if ($_GET["module"]=="rekam_medis" || $_GET["module"]=="form_obat") { ?>
    <li class="active">
      <a href="?module=rekam_medis"><i class="fa fa-folder"></i> Data Rekam Medis </a>
      </li>
  <?php
  }
  // jika tidak, menu data rkam medis tidak aktif
  else { ?>
    <li>
      <a href="?module=rekam_medis"><i class="fa fa-folder"></i> Data Rekam Medis </a>
      </li>
...
// pembuatan Laporan
	// jika menu Laporan Kunjungan dipilih, menu Laporan Data Kunjungan aktif
  if ($_GET["module"]=="lap_kunjungan") { ?>
    <li class="active treeview">
            <a href="javascript:void(0);">
              <i class="fa fa-file-text"></i> <span>Laporan</span> <i class="fa fa-angle-left pull-right"></i>
            </a>
          <ul class="treeview-menu">
            <li><a href="?module=lap_kunjungan"><i class="fa fa-circle-o"></i> Data Kunjungan </a></li>
            <li><a href="?module=lap_medis"><i class="fa fa-circle-o"></i> Data Medis </a></li>
    ...
    // jika menu Laporan Medis dipilih, menu Laporan Medis aktif
  if ($_GET["module"]=="lap_medis") { ?>
    <li class="active treeview">
            <a href="javascript:void(0);">
              <i class="fa fa-file-text"></i> <span>Laporan</span> <i class="fa fa-angle-left pull-right"></i>
            </a>
