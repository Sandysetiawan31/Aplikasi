...
if (isset($_GET['tgl_awal'])) {
    ...
    $query = mysqli_query($mysqli, "SELECT a.kode_keluar,a.tanggal,a.kode_obat,a.jumlah,b.kode_obat,b.nama_obat,b.satuan
    ...
    ORDER BY a.kode_keluar ASC") 
    or die('Ada kesalahan pada query tampil Keluar : '.mysqli_error($mysqli));
    ...
    // jika data tidak ada
        ...
        while ($data = mysqli_fetch_assoc($query)) {
            ...
            echo "  <tr>
                        ...
                        <td width='120' height='13' align='center' valign='middle'>$data[kode_keluar]</td>
                        ...
                        <td width='80' height='13' align='center' valign='middle'>$data[nama_obat]</td>
                        <td width='100' height='13' align='center' valign='middle'>$data[jumlah]</td>
