        ...
        <div class="box-body">
          ...
          <table id="dataTables1" class="table table-bordered table-striped table-hover">
            ...
            // fungsi query untuk menampilkan data dari tabel obat
             $query = mysqli_query("SELECT kode_obat,nama_obat,btk_obat,atr_pakai FROM is_obat ORDER BY kode_obat ASC")                                            or die('Ada kesalahan pada query tampil Data Obat: '.mysqli_error($mysqli));
            ...
            while ($data = mysqli_fetch_assoc($query))
             ...
             // menampilkan isi tabel dari database ke tabel di aplikasi
              echo "<tr>
                      ...
                      <td width='80' align='right'>$data[btk_obat]</td>
                      <td width='80' class='center'>$data[atr_pakai]</td>
            ...
            ?>
                          <a data-toggle="tooltip" data-placement="top" title="Hapusaaa" class="btn btn-danger btn-sm" href="modules/obat/det.php?act=delete&id=<?php echo $data['kode_obat'];?>" onclick="return  <?php echo $data['nama_obat']; ?> ?');">
                              <i style="color:green" class="glyphicon glyphicon-edit"></i>
                          </a>
            <?php
              echo "    </div>
                      </td>
