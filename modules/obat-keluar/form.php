      ...
      <div class="col-md-12">
        <div class="box box-primary">
          ...
          <form role="form" class="form-horizontal" action="modules/obat-keluar/proses.php?act=insert" method="POST" name="formObatMasuk">
            <div class="box-body">
              <?php  
              // fungsi untuk membuat kode keluar
              $query_id = mysqli_query($mysqli, "SELECT RIGHT(kode_keluar,4) as kode FROM is_obat_keluar
                                                ORDER BY kode_keluar DESC LIMIT 1")
                                                or die('Ada kesalahan pada query tampil kode_keluar : '.mysqli_error($mysqli));
              ...
              $kode_keluar = "OBT-$tahun-$buat_id";
              ?>

              <div class="form-group">
                <label class="col-sm-2 control-label">Kode Keluar</label>
                <div class="col-sm-5">
                  <input type="text" class="form-control" name="kode_keluar" value="<?php echo $kode_keluar; ?>" readonly required>
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-5">
                  <input type="text" class="form-control" id="jumlah_masuk" name="jumlah" autocomplete="off" onKeyPress="return goodchars(event,'0123456789',this)" onkeyup="hitung_total_stok(this)&cek_jumlah_masuk(this)" required>
                </div>
              </div>
