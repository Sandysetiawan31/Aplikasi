             ...
             <div class="form-group">
                <label class="col-sm-2 control-label"></label>
                  <div class="col-sm-5" style="width:200px">
                   <select class="chosen-select" name="t1" id="t1" data-placeholder="-- Pilih Obat 1--" onchange="tampil_obat(this)" >
                    <option value=""></option>
                    <?php
              ...
              <div class="form-group">
                <label class="col-sm-2 control-label"></label>
                  <div class="col-sm-5" style="width:200px">
                   <select class="chosen-select" name="t2" id="t2" data-placeholder="-- Pilih Obat 2--" onchange="tampil_obat(this)" >
                    <option value=""></option>
                    <?php
                      $query_obat = mysqli_query($mysqli, "SELECT kode_obat, nama_obat FROM is_obat ORDER BY nama_obat ASC")
                       or die('Ada kesalahan pada query tampil obat: '.mysqli_error($mysqli));
              ...
              <div class="form-group">
                <label class="col-sm-2 control-label"></label>
                  <div class="col-sm-5" style="width:200px">
                   ...
                   <select class="chosen-select" name="t3" id="t3" data-placeholder="-- Pilih Obat 3--" onchange="tampil_obat(this)" >
                    <option value=""></option>
                    <?php
                      $query_obat = mysqli_query($mysqli, "SELECT kode_obat, nama_obat FROM is_obat ORDER BY nama_obat ASC")
                       or die('Ada kesalahan pada query tampil obat: '.mysqli_error($mysqli));
              ...
              <div class="form-group">
                <label class="col-sm-2 control-label"></label>
                  <div class="col-sm-5" style="width:200px">
                   <select class="chosen-select" name="t4" id="t2" data-placeholder="-- Pilih Obat 4--" onchange="tampil_obat(this)" >
                    <option value=""></option>
                    <?php
                      $query_obat = mysqli_query($mysqli, "SELECT kode_obat, nama_obat FROM is_obat ORDER BY nama_obat ASC")
                       or die('Ada kesalahan pada query tampil obat: '.mysqli_error($mysqli));
              ...
              <div class="form-group">
                <label class="col-sm-2 control-label"></label>
                  <div class="col-sm-5" style="width:200px">
                   <select class="chosen-select" name="t5" id="t3" data-placeholder="-- Pilih Obat 5--" onchange="tampil_obat(this)" >
                    <option value=""></option>
                    <?php
                      $query_obat = mysqli_query($mysqli, "SELECT kode_obat, nama_obat FROM is_obat ORDER BY nama_obat ASC")
                       or die('Ada kesalahan pada query tampil obat: '.mysqli_error($mysqli));
